...
import (
	...
	"github.com/tsunyoku/danser/framework/platform"
...
func run() {
	mainthread.Call(func() {
		...
		// HACK HACK HACK: please see github.com/tsunyoku/danser/framework/graphics/buffer.IsIntel for more info
